...
class SetupDatabase:
    ...
    def is_molecule_setup(self, molecule_id):
        ...
        be generated by OpenEye.

        An example to clarify the difference between the two return values: a protein
        in a pdb does not have to be processed (since it does not go through antechamber)
        thus the function will return is_setup=True and is_processed=False.
    ...
    def _setup_molecules(self, *args):
        ...
        for mol_id in args:
            ...
            if mol_descr['parameters'] == 'antechamber':
                ...
                # Save new parameters paths, and keep track of processed molecule
