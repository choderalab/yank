...
from . import utils, pipeline, mpi, restraints, schema, sampling
...
class AlchemicalPhaseFactory(object):
    ...
    storage : yank.sampling.MultiStateReporter or str
        ...
        Will be a :class:`yank.sampling.MultiStateReporter` internally if str is given
    ...
    def create_alchemical_phase(self):
        ...
        if isinstance(self.storage, str):
            ...
            reporter = sampling.MultiStateReporter(self.storage, checkpoint_interval=checkpoint_interval,
    ...
    def run(self, n_iterations=None):
        ...
        while iterations_left != [0, 0]:
            ...
            for phase_id, phase in enumerate(self.phases):
                ...
                except sampling.SimulationNaNError:
...
class ExperimentBuilder(object):
    ...
    def _determine_experiment_options(self, experiment):
        ...
        sampler_options = _filter_options(sampling.ReplicaExchangeSampler.default_options())
    ...
    def _validate_options(cls, options, validate_general_options):
        ...
        template_options.update(sampling.ReplicaExchangeSampler.default_options())
    ...
    def _build_experiment(self, experiment_path, experiment):
        ...
        for phase_idx, (phase_name, phase_path) in enumerate(zip(phase_names, phase_paths)):
            ...
            sampler = sampling.ReplicaExchangeSampler(mcmc_moves=mcmc_move, **sampler_opts)
