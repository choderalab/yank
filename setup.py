...
setup(
    ...
    package_data={'yank' : find_package_data('examples', 'yank') + find_package_data('Yank/data', 'yank')},  # NOTE: examples installs to yank.egg/examples/, NOT yank.egg/yank/examples/.  You need to do utils.get_data_filename("../examples/*/setup/").
    zip_safe=False,
    install_requires=[
        'numpy',
        'scipy',
