...
exclude_patterns = ['_build', 'versions_div_theme']
...
html_theme_path = [versions_div_theme.get_html_theme_path(),
...
# pixels large.
html_favicon = '_static/yankIcon.png'
