...
yank prepare binding amber --setupdir=setup --ligand="resname SAI" --store=output --iterations=$NITERATIONS --nbmethod=CutoffPeriodic --temperature="300*kelvin" --pressure="1*atmosphere" --minimize --verbose
